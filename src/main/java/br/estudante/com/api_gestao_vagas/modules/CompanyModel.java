...
public class CompanyModel {
    ...
    @NotBlank(message = "O bussinessName não pode esta vazio, e não deve conter espacos")
    @Length(min = 5, max = 20, message = "O bussinessName deve conter entre 5 a 20 strings")
